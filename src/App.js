...
firebase.initializeApp({
  ...
  appId: "1:708994302824:web:21971faf79cd19a7480cdd",
  measurementId: "G-EWC82DYBDC"
});
...
function ChatRoom() {
  ...
  useEffect(() => {
    dummy.current.scrollIntoView({behavior: 'smooth'}); // eslint-disable-next-line
  }, messages);
